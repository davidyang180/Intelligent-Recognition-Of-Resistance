...
public abstract class ItemViewBinder<T, VH extends RecyclerView.ViewHolder> {
     ...
     * update the contents of the {@link RecyclerView.ViewHolder#itemView} to reflect the given item.
     * <p>
     ...
     * <p>
     * If you need the position of an item later on (e.g. in a click listener), use
     * {@link RecyclerView.ViewHolder#getAdapterPosition()} which will have the updated adapter position.
     * <p>
     ...
     * the internal position equals to {@link RecyclerView.ViewHolder#getAdapterPosition()}.
     ...
     * @since v2.3.5. If below v2.3.5, use {@link RecyclerView.ViewHolder#getAdapterPosition()} instead.
     */
     ...
     * {@link #onBindViewHolder(RecyclerView.ViewHolder, Object)} call when View is rebound to a new item.
