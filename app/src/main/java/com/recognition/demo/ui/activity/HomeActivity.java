...
import com.recognition.base.BaseFragmentAdapter;
...
import com.recognition.demo.helper.DoubleClickHelper;
import com.recognition.demo.ui.fragment.LishiFragmentA;
import com.recognition.demo.liebiao.PhotoFragment;
import com.recognition.demo.ui.fragment.TestFragmentD;
...
//        mViewPager.setPageTransformer(true, new ZoomFadePageTransformer());
    ...
    protected void initData() {
        ...
        mPagerAdapter.addFragment(MainActivity.newInstance());
        mPagerAdapter.addFragment(PhotoFragment.newInstance());
        mPagerAdapter.addFragment(LishiFragmentA.newInstance());
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.home_found:
                ...
                //mViewPager.setCurrentItem(1, mViewPager.getCurrentItem() == 3);
                mViewPager.setCurrentItem(1, mViewPager.getCurrentItem() == 0 || mViewPager.getCurrentItem() == 2);
                return true;
            case R.id.home_message:
                //mViewPager.setCurrentItem(2);
                //mViewPager.setCurrentItem(2, false);
                //mViewPager.setCurrentItem(2, mViewPager.getCurrentItem() == 0 || mViewPager.getCurrentItem() == 3);
                mViewPager.setCurrentItem(2, mViewPager.getCurrentItem() == 1 || mViewPager.getCurrentItem() == 3);
                return true;
            case R.id.home_me:
                //mViewPager.setCurrentItem(3);
                //mViewPager.setCurrentItem(3, false);
                //mViewPager.setCurrentItem(3, mViewPager.getCurrentItem() == 2 || mViewPager.getCurrentItem() == 1);
